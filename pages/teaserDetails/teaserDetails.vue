<template>
	<view class="page">
		<view class="head">
			...
			<view class="movie-detail">
				...
				<view class="detail-info">
					...
					<view class="detail-info-enm" style="margin-top: 10rpx;">
						上映时间:{{list.playDate}}
					</view>
				</view>
			</view>
		...
		<view class="movie-detail-vedio" >
			<video id="movievedio" :src="'http://124.93.196.45:10091'+list.video" :poster="list.videoImg"
				class="movie-vedio"></video>
	</view>
		<view class="buy">
			<u-button customStyle="width:80%" type="primary" shape="circle" text="即将上映"></u-button>
		</view>
	</view>
	</view>
</template>
<script>
	...
	export default {
		...
		onLoad() {
			let id = this.$store.state.movie.movieId
			getTeaserViewInfo(id).then((res) => {
				console.log(res)
				this.list = res.data
			}).catch()
		},
