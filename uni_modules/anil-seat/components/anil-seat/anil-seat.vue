  ...
  <view class="sel-seat">
    ...
    <view class="seat-main">
            ...
            class="sm-cell" :style="'width:'+boxWidth+'px;height:'+seatSize+'px'">
          	<view v-for="(seat,col) in item" :key="col" class="dp-ib" :style="'width:'+seatSize+'px;height:'+seatSize+'px'"
          	 @click="handleChooseSeat(index,col)">
          		<image v-if="seat.type===0" class="sm-icon" src="@/static/image/unselected.png" mode="aspectFit"></image>
          		<image v-else-if="seat.type===1" class="sm-icon" src="@/static/image/selected.png" mode="aspectFit"></image>
          		<image v-else-if="seat.type===2" class="sm-icon" src="@/static/image/bought.png" mode="aspectFit"></image>
          	</view>
          </view>
      ...
      <view class="fix-tips" v-if="showTis">
      	<view class="v-tips">
      		<image :style="'width:'+seatSize+'px;height:'+seatSize+'px'" src="@/static/image/unselected.png" mode="aspectFit"></image>
          <text class="text">可选</text>
      	</view>
      	<view class="v-tips">
      		<image :style="'width:'+seatSize+'px;height:'+seatSize+'px'" src="@/static/image/bought.png" mode="aspectFit"></image>
          <text class="text">不可选</text>
      	</view>
      	<view class="v-tips">
      		<image :style="'width:'+seatSize+'px;height:'+seatSize+'px'" src="@/static/image/selected.png" mode="aspectFit"></image>
      ...
      return {
		...
		methods: {
			...
			initNonSeatPlace: function() {
				...
				for (let num in seat) {
					let status = 2 //-1为非座位，0或null为未购座位，1为已选座位(绿色),2为已购座位(红色)
					if (seat[num].Status === 0||seat[num].Status===null) {
						status = 0
